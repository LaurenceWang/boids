...
private:
    ...
    Object _lumiere{_ObjectProgram, glimac::sphere_vertices(0.2f, 32, 16)};
    ...
    objectParameters              _lum{glm::vec3(0.f, 0.f, 0.0f), 0, 1};
    ...
    void switchProgram(std::string shaderPath);
